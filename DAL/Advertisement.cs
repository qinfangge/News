...
namespace CMS.DAL
{
	...
	public partial class Advertisement
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Advertisement"); 
		}
		...
		public int Add(CMS.Model.Advertisement model)
		{
			...
			strSql.Append("name,image,url,startTime,endTime)");
		...
		public CMS.Model.Advertisement GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,image,url,startTime,endTime from Advertisement ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.Advertisement DataRowToModel(DataRow row)
		{
			CMS.Model.Advertisement model=new CMS.Model.Advertisement();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,image,url,startTime,endTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,name,image,url,startTime,endTime ");
			strSql.Append(" FROM Advertisement ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string condition, string order, int pageSize, int currentPage, bool isGeneral)
        {
            ...
            string strSql = string.Format(@"SELECT TOP  {0}  *
                            ...
                            WHERE id NOT IN
                                        (
                                        SELECT TOP  {1} id FROM Advertisement {2} {3}
                                        )
