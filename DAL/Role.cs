...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014/3/22 14:35:58   N/A    初版
*
...
namespace CMS.DAL
{
	...
	public partial class Role
	{
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(CMS.Model.Role model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Role(");
            strSql.Append("name,isShow,sort,isDefault)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(CMS.Model.Role model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public CMS.Model.Role GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,name,isShow,sort,isDefault from Role ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public CMS.Model.Role DataRowToModel(DataRow row)
        {
            CMS.Model.Role model = new CMS.Model.Role();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,name,isShow,sort,isDefault ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,name,isShow,sort,isDefault ");
            strSql.Append(" FROM Role ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Role set isDefault=0 ");
        ...
        /// 得到一个默认的对象实体
        /// </summary>
        public CMS.Model.Role GetDefaultModel()
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,name,isShow,sort,isDefault from Role ");
            strSql.Append(" where isDefault=@isDefault");
            SqlParameter[] parameters = {
					new SqlParameter("@isDefault", SqlDbType.Bit,1)
			};
