...
namespace CMS.DAL
{
	...
	public partial class FriendLink
	{
		...
		public int Add(CMS.Model.FriendLink model)
		{
			...
			strSql.Append("name,url,image,sort)");
		...
		public CMS.Model.FriendLink GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,url,image,sort from FriendLink ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.FriendLink DataRowToModel(DataRow row)
		{
			CMS.Model.FriendLink model=new CMS.Model.FriendLink();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,url,image,sort ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,name,url,image,sort ");
			strSql.Append(" FROM FriendLink ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string condition, string order, int pageSize, int currentPage, bool isGeneral)
        {
            ...
            string strSql = string.Format(@"SELECT TOP  {0}  *
                            ...
                            WHERE id NOT IN
                                        (
                                        SELECT TOP  {1} id FROM FriendLink {2} {3}
                                        )
