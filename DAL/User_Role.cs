...
namespace CMS.DAL
{
	...
	public partial class User_Role
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(CMS.Model.User_Role model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CMS.Model.User_Role model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.User_Role GetModel(int id)
		{
			...
			CMS.Model.User_Role model=new CMS.Model.User_Role();
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.User_Role DataRowToModel(DataRow row)
		{
			CMS.Model.User_Role model=new CMS.Model.User_Role();
			if (row != null)
			{
