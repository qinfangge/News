...
namespace CMS.DAL
{
	...
	public partial class GuestBook
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "GuestBook"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(CMS.Model.GuestBook model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into GuestBook(");
			strSql.Append("title,name,mobile,content,addTime,reply,replyTime,isChecked)");
			...
			parameters[7].Value = model.isChecked;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CMS.Model.GuestBook model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.GuestBook GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,name,mobile,content,addTime,reply,replyTime,isChecked from GuestBook ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.GuestBook DataRowToModel(DataRow row)
		{
			CMS.Model.GuestBook model=new CMS.Model.GuestBook();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,name,mobile,content,addTime,reply,replyTime,isChecked ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,title,name,mobile,content,addTime,reply,replyTime,isChecked ");
			strSql.Append(" FROM GuestBook ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string condition, string order, int pageSize, int currentPage, bool isGeneral)
        {
            ...
            string strSql = string.Format(@"SELECT TOP  {0}  *
                            ...
                            WHERE id NOT IN
                                        (
                                        SELECT TOP  {1} id FROM GuestBook {2} {3}
                                        )
