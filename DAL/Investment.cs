...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014/2/21 16:33:26   N/A    初版
*
...
namespace CMS.DAL
{
	...
	public partial class Investment
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(CMS.Model.Investment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Investment(");
			strSql.Append("title,name,mobile,content,addTime,category,type,isChecked)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CMS.Model.Investment model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.Investment GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,name,mobile,content,addTime,category,type,isChecked from Investment ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.Investment DataRowToModel(DataRow row)
		{
			CMS.Model.Investment model=new CMS.Model.Investment();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,name,mobile,content,addTime,category,type,isChecked ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,title,name,mobile,content,addTime,category,type,isChecked ");
			strSql.Append(" FROM Investment ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string condition, string order, int pageSize, int currentPage, bool isGeneral)
        {
            ...
            string strSql = string.Format(@"SELECT TOP  {0}  *
                            ...
                            WHERE id NOT IN
                                        (
                                        SELECT TOP  {1} id FROM Investment {2} {3}
                                        )
