...
namespace CMS.BLL
{
	...
	{
		private readonly CMS.DAL.Attachment dal=new CMS.DAL.Attachment();
		public Attachment()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CMS.Model.Attachment GetModelByCache(int id)
		{
			...
			return (CMS.Model.Attachment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Attachment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Attachment> DataTableToList(DataTable dt)
		{
			List<CMS.Model.Attachment> modelList = new List<CMS.Model.Attachment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CMS.Model.Attachment model;
