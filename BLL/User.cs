...
namespace CMS.BLL
{
	...
	{
		private readonly CMS.DAL.User dal=new CMS.DAL.User();
		public User()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CMS.Model.User GetModelByCache(int id)
		{
			...
			return (CMS.Model.User)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.User> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.User> DataTableToList(DataTable dt)
		{
			List<CMS.Model.User> modelList = new List<CMS.Model.User>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CMS.Model.User model;
