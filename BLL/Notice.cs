...
namespace CMS.BLL
{
	...
	{
		private readonly CMS.DAL.Notice dal=new CMS.DAL.Notice();
		public Notice()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CMS.Model.Notice GetModelByCache(int id)
		{
			...
			return (CMS.Model.Notice)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Notice> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Notice> DataTableToList(DataTable dt)
		{
			List<CMS.Model.Notice> modelList = new List<CMS.Model.Notice>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CMS.Model.Notice model;
