...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014/8/11 14:39:43   N/A    初版
*
...
namespace CMS.BLL
{
	...
	{
		private readonly CMS.DAL.Comment dal=new CMS.DAL.Comment();
		public Comment()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CMS.Model.Comment GetModelByCache(int id)
		{
			...
			return (CMS.Model.Comment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Comment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CMS.Model.Comment> DataTableToList(DataTable dt)
		{
			List<CMS.Model.Comment> modelList = new List<CMS.Model.Comment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CMS.Model.Comment model;
