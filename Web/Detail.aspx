                                ...
                                <div id="tiePostBox" class="tie-post js-post-area tie-post-list">
                                    ...
                                    <div class="tie-postform">
                                        ...
                                        <div class="tie-author js-tie-author">
                                            <asp:Panel ID="UnLoginPanel" runat="server">
                                                ...
                                                <div style="display: block;" class="js-login">
                                                    <div class="tie-author-logon">
                                                        <a href="http://tie.163.com/reply/myaction.jsp?action=reply2me&amp;username=&lt;#=userId#&gt;" class="js-tie-myhome" target="_blank" rel="nofollow">
                                                            <strong class="js-tie-username">封丘门户网</strong></a>&nbsp; <a href="http://tie.163.com/reply/myaction.jsp?action=reply2me&amp;username=&lt;#=userId#&gt;" target="_blank" class="js-tie-myposts" rel="nofollow">我的跟贴</a> |
           
                                                        <a href="http://t.163.com/" target="_blank" rel="nofollow">我的微博</a> | <a target="_self" href="http://reg.163.com/Logout.jsp?username=&lt;#=userId#&gt;&amp;url=http://j.news.163.com/" class="js-tie-logout" rel="nofollow">退出</a>
                                                    </div>
                                                    <div class="tie-author-login">
                                                        <label class="js-syn">
                                                            <input type="checkbox" checked="checked"><em class="tie-sprite"></em></label>
                                        ...
                                        <asp:Repeater ID="HotReplayRepeater" runat="server">
                                            <ItemTemplate>
                                                <div id="recA2UQ5B0J" class="tie-reply js-tie-reply">
                                                    <div class="tie-photo">
                                                        <a href="javascript://A2UQ5B0J" class="js-digicon tie-digicon" target="_self"><span></span></a>
                                                        <div class="rec-digcount js-rec-digcount"><%#Eval("dig") %></div>
                                                    </div>
                                                    <div class="tie-inner js-tie-inner">
                                                        <span class="tie-sum-author"><span class="tie-from layerUserName"><a target="_blank" href="http://t.163.com/1935268330">村长在家</a>                                </span><span class="tie-ip">[<%#GetAddress(Eval("ip").ToString()) %>]</span>            </span><span class="tie-postTime"><%#Eval("addTime") %></span>
                                                        <div class="tie-body js-body">
                                                            <div class="tie-oneLayer layerFontColor js-body"><%#Eval("content") %></div>
                                                        </div>
                                                        <ul class="tie-operations">
                                                            <li class="support"><a class="js-ding" href="javascript://A2UQ5B0J" target="_self" rel="nofollow">顶<em class="js-ding-em">[<%#Eval("dig") %>]</em></a></li>
                                        ...
                                        <asp:Repeater ID="NewReplayRepeater" runat="server">
                                            <ItemTemplate>
                                                <div id="tieA3291GAA" class="tie-reply js-tie-reply ">
                                                    ...
                                                    <div class="tie-inner js-tie-inner">
                                                        <span class="tie-sum-author"><span class="tie-from layerUserName">18351937185                                </span><span class="tie-ip">[<%#GetAddress(Eval("ip").ToString()) %>]</span>            </span><span class="tie-postTime"><%#Eval("addTime") %></span>
                                                        <div class="tie-body js-body">
                                                        ...
                                                        <ul class="tie-operations">
                                                            <li class="support"><a class="js-ding" href="javascript://A3291GAA" target="_self" rel="nofollow">顶<em class="js-ding-em">[<%#Eval("dig") %>]</em></a></li>
