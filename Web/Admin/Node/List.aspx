<%@ Page Title=" 管理权限" Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CMS.Web.Admin.Node.List" %>
...
<ControlStyle Width="30px"></ControlStyle>
		...
		<asp:BoundField DataField="name" HeaderText="权限" SortExpression="userName" ItemStyle-HorizontalAlign="Center"  > 
		                <HeaderStyle Width="8em" />
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
		<asp:BoundField DataField="url" HeaderText="地址" SortExpression="realName" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
