<%@ Page Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="CMS.Web.Admin.Investment.Modify" Title="修改信息" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.UEDITOR_CONFIG.scrawlPath = "/";
        window.UEDITOR_CONFIG.videoPath = "/";
        window.UEDITOR_CONFIG.wordImagePath = "/";
        window.UEDITOR_CONFIG.snapscreenPath = "/";
