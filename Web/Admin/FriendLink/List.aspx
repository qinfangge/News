<%@ Page Title="管理链接" Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CMS.Web.Admin.FriendLink.List" %>
...
<ControlStyle Width="30px"></ControlStyle>
		...
		<asp:BoundField DataField="name" HeaderText="网站名称" SortExpression="name" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
		                <asp:HyperLinkField DataNavigateUrlFields="url" DataTextField="url" HeaderText="链接地址" Target="_blank">
