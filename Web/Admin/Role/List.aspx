<%@ Page Title=" 管理角色 " Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CMS.Web.Admin.Role.List" %>
...
<ControlStyle Width="30px"></ControlStyle>
		...
		<asp:BoundField DataField="Name" HeaderText="角色" ItemStyle-HorizontalAlign="Center"  > 
		                <HeaderStyle Width="8em" />
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                            
                            <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="Assign.aspx?id={0}" DataTextFormatString="分配" HeaderText="分配权限" Text="分配">
...
<ControlStyle Width="50px"></ControlStyle>
                        ...
                        <asp:CheckBoxField DataField="isShow" HeaderText="是否显示" Text="显示">
                        <HeaderStyle Width="8em" />
                        <ItemStyle CssClass="isShow" />
                        </asp:CheckBoxField>
                        </Columns>
