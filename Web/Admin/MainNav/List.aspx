<%@ Page Title="MainNav" Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CMS.Web.MainNav.List" %>
...
<ControlStyle Width="30px"></ControlStyle>
		...
		<asp:BoundField DataField="link" HeaderText="链接" SortExpression="link" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
		<asp:BoundField DataField="name" HeaderText="名称" SortExpression="name" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
		<asp:BoundField DataField="target" HeaderText="新窗口打开" SortExpression="target" ItemStyle-HorizontalAlign="Center"  > 
