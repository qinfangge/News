<%@ Page Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="CMS.Web.Admin.Project.Add" Title="添加项目" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
	...
	：</td>
	<td class="textWrapper">
		<asp:TextBox ID="txtstartTime" runat="server" onclick="WdatePicker({startDate:'%y-%M-%d 08:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'})"  CssClass="date"></asp:TextBox>
	</td></tr>
	<tr>
	<td >
		截止日期
	：</td>
	<td class="textWrapper">
		<asp:TextBox ID="txtendTime" runat="server"  onclick="WdatePicker({startDate:'%y-%M-%d 17:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'})" CssClass="date"></asp:TextBox>
	</td></tr>
	...
	：</td>
	<td class="textWrapper">
		<uc1:Category ID="Category1" ParentId="2"  runat="server" />
	</td></tr>
        <tr>
                <td>推荐到
	：</td>
