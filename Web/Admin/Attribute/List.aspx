<%@ Page Title="Attribute" Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CMS.Web.Admin.Attribute.List" %>
...
<ControlStyle Width="30px"></ControlStyle>
		...
		<asp:BoundField DataField="name" HeaderText="属性名称" SortExpression="name" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
		<asp:BoundField DataField="cssClass" HeaderText="类名" SortExpression="style" ItemStyle-HorizontalAlign="Center"  > 
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
